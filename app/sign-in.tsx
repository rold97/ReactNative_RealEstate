            ...
            <ScrollView contentContainerClassName="h-full">
                ...
                <View className="px-10">
                    ...
                    <Text className="text-3xl font-rubik-bold text-black-300 text-center mt-2">
                        ...
                        <Text className="text-primary-300">Your Ideal Home
                        </Text>
                    </Text>

                    <Text className="text-lg font-rubik text-black-200 text-center mt-12">Login to ReState with Google</Text>

                    <TouchableOpacity onPress={handleLogin} className="bg-white shadow-md ripple-zinc-300 rounded-full w-full py-4 mt-5">
